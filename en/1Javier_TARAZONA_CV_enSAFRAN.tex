...
\begin{tabularx}{\textwidth}{@{}>{\centering\arraybackslash}p{0.115\textwidth}X@{}}
  ...
  \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
            ...
            \footnotesize Engineering student in AI - Deep Learning and Computer Vision & \href{mailto:javier-andres.tarazona@ensta-paris.fr}{javier-andres.tarazona@ensta-paris.fr}\\
...
\textbf{Seeking a 5 to 6 month Deep Learning Scientist internship in AI and computer vision, starting in September 2026.}
...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.24\textwidth}}
  ...
  \textit{\footnotesize Relevant coursework: Machine Learning, Deep Learning, Image Recognition, Statistics, Optimization}
  \end{minipage}
  &
  ...
  \textit{\footnotesize Relevant coursework: Software Engineering, Algorithms, Stochastic Models, Optimization, Multi-Agent Systems}
  \end{minipage}
  &
  \begin{minipage}[t]{\linewidth}\raggedleft
...
\section{\textcolor{mydarkgreen}{\textbf{PROFESSIONAL EXPERIENCE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\footnotesize Research Intern in Deep Learning and 3D Vision}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Deep learning for imagery: } Self-supervised pre-training through novel-view prediction with \textbf{PyTorch} and \textbf{Vision Transformers} to learn 3D structure.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Training data generation: } \textbf{Python/Blender} pipeline for controlled multi-view renders, cameras, metadata and training datasets.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Experimental plans: } Curriculum learning on progressively complex geometric shapes to structure training and evaluation.}
      \end{minipage}
    }\\
    ...
    \begin{minipage}[t]{\linewidth}\raggedleft
      \textbf{Paris, France}\\
      {\footnotesize\textit{October 2025 - Paused February 2026}}
    \end{minipage}\\

    \multicolumn{2}{l}{
    \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Robust AI development: } Local French text correction application based on a \textbf{rules \& LLMs pipeline}, with spaCy NER guardrails, entity/number checks and RAM/VRAM-based model selection.}
    \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Python software engineering: } Refactoring of two libraries into an object-oriented, modular architecture, automating image analysis and data processing \textbf{(+80 \% work efficiency)}.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Computer vision: } Optimization of \textbf{OpenCV/NumPy} post-processing for lanes and road markings (\textbf{+50 \% speed, +60 \% accuracy}) and WheelPath trajectory generation.}
      \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{ACADEMIC PROJECTS}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      \textbullet\ \textbf{"Slow" - Vehicle detection and tracking on video}\\
      \textit{\footnotesize Python, MySQL, OpenCV}\\
      \indentbox{\footnotesize Video analysis for vehicle recognition, traffic monitoring and speed measurement. Project focused on object detection, image processing and automation. \href{https://github.com/JavierTarazona06/slow}{\textcolor{blue}{\underline{More information}}}.}\\
    \end{minipage}
    &
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\footnotesize Python, OpenCV, NumPy, scikit-learn, K-Means, Gaussian Naive Bayes, RGB/HSV/YCrCb.}\\
      \indentbox{\footnotesize Comparison of supervised Bayesian and unsupervised methods to segment pixels in images, with an evaluation protocol. \href{https://github.com/JavierTarazona06/Vision_LocalFeatures_BayesianClassification_KMeans/blob/main/docs/rappport/rap.pdf}{\textcolor{blue}{\underline{More information}}}.}
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Text here
    \end{minipage}\\
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      \textbullet\ \textbf{"Tameo" - Embedded computer vision (ongoing project)}\\
      \indentbox{\footnotesize Perception system for an AI-class boat at the Monaco Energy Boat Challenge 2026.}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Text here
    \end{minipage}\\
...
\begin{minipage}[t]{0.60\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      \item \textbf{AI \& vision:} Deep Learning, Machine Learning, PyTorch, Vision Transformers, OpenCV, NumPy, Pandas, scikit-learn, Blender/Python API
      \item \textbf{Software development:} Python, software architecture, automation, quality/testing, Docker, FastAPI, Django, GCP, SQL/NoSQL, C++/C, Java
      \item \textbf{Methodologies:} Git/GitHub, CI/CD, Agile (SCRUM), experimental plans, model evaluation
    \end{itemize}
  }
