...
\section{\textcolor{mydarkgreen}{\textbf{PROFESSIONAL EXPERIENCE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Python Development and Software Structuring: }Refactoring of two libraries into an object-oriented, modular architecture, automating image analysis and data processing \textbf{(+80 \% work efficiency)}.}
      \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{ACADEMIC PROJECTS}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \indentbox{\footnotesize Computer vision system for an AI-class boat at the Monaco Energy Boat Challenge 2026.}\\
    \end{minipage}
    &
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \indentbox{\footnotesize Video analysis for vehicle recognition and speed measurement, automating traffic monitoring. \href{https://github.com/JavierTarazona06/slow}{\textcolor{blue}{\underline{More information}}}.}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Text here
    \end{minipage}\\
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \indentbox{\footnotesize Comparison of supervised Bayesian methods and K-Means to segment skin pixels in face images. \href{https://github.com/JavierTarazona06/Vision_LocalFeatures_BayesianClassification_KMeans/blob/main/docs/rappport/rap.pdf}{\textcolor{blue}{\underline{More information}}}.}
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Text here
    \end{minipage}\\
