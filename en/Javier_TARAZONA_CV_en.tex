...
\begin{tabularx}{\textwidth}{@{}>{\centering\arraybackslash}p{0.115\textwidth}X@{}}
  ...
  \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
            ...
            \href{https://github.com/JavierTarazona06}{\textcolor{blue}{\underline{GitHub}}} & Paris, Île de France, France\\
        \end{tabular*}
    \\
\end{tabularx}
...
\textbf{Seeking a 5 to 6 months internship in artificial intelligence, starting in September 2026}
