...
\fancyfoot[C]{\footnotesize \textbf{Interests}: Tennis, hiking, cycling, fencing \;
\textbullet\; Travel (Europe, USA, Canada, Mexico, Colombia) \;
\textbullet\; \\Reading (psychology of emotions and human relationships).}
...
\begin{tabularx}{\textwidth}{>{\hsize=0.23\hsize}X>{\hsize=1.72\hsize}X}
  ...
  \begin{tabular*}{\linewidth}{l@{\extracolsep{\fill}}r}
            ...
            Systems and Computer Engineer & \href{mailto:javier-andres.tarazona@ensta-paris.fr}{javier-andres.tarazona@ensta-paris.fr}\\
...
\section{\textcolor{mydarkgreen}{\textbf{Education}}}
  ...
  {\shortstack[l]{
    ...
    \\\underline{\textbf{Eiffel Excellence Scholarship – Master's 2025–2027}}}}{September 2025 -- Present}
    \resumeSubheading
      {Universidad Nacional de Colombia (UNAL)}{Bogotá, Colombia}
      {\shortstack[l]{Systems and Computer Engineering; GPA: 4.7/5.0
            \\\underline{\textbf{Tuition waiver for academic excellence} (2021–2024)}}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Python development \& software design}
          {Refactored two libraries using object-oriented and modular design, optimizing image analysis and automating data processing (improved developer efficiency by 80 \% ).}
        \resumeItem{Computer Vision (OpenCV, NumPy, mathematics)}
          {Improved a post-processing pipeline for lane and road marking detection, increasing speed by 50\% and accuracy by 60\%.}
        \resumeItem{Data analysis and abstraction}
          {Generated wheel-path trajectories and correlated deterioration zones, improving overall system performance and user satisfaction (+10\%).}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{\textcolor{mydarkgreen}{\textbf{Academic Projects}}}
  \resumeSubHeadingListStart
      ...
      \resumeSubheading
      {Slow}{}
      {Desktop application – Python, MySQL, OpenCV}{}
      \resumeItemListStart
      ...
      \resumeItemListStart
        ...
        Supervised and vallidated by the Innovation Management Unit of the
        Universidad Nacional de Colombia for ORIUN project.}
      \resumeItemListEnd
...
{\begin{itemize}[leftmargin=*,itemsep=2pt,parsep=0pt,topsep=2pt,partopsep=0pt]
  \item{\textbf{Honorable Mention – ICPC Colombia 2023} \newline XXXVII National Programming Marathon ACIS REDIS}
   \item{\textbf{Programming:} Python, JavaScript, C++/C, Java, SQL/NoSQL.}
   ...
   \item{\textbf{Languages:} English (C1 – \textbf{IELTS 2024}), 
    French (B2 – \textbf{DELF 2024}), Spanish (native).}
