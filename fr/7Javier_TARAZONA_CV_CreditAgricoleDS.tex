...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Deep Learning et Transformers : } Pré-entraînement auto-supervisé avec \textbf{PyTorch} et \textbf{Vision Transformers}; curriculum learning pour structurer les entraînements et l'évaluation.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Pipelines de données : } Génération \textbf{Python/Blender} de rendus multi-vues, caméras, métadonnées et jeux de données contrôlés pour l'entraînement.}
      \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
    \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- NLP et IA générative : } Application locale de correction de texte en français par \textbf{pipeline règles \& LLMs} (LanguageTool, Mistral/Gemma), avec NER spaCy, contrôles entités/nombres et sélection dynamique selon RAM/VRAM.}
    \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Refactorisation Python : } Refactorisation de deux bibliothèques en architecture objet/modulaire; amélioration de \textbf{70 \% du score de refactorisation} (indice de maintenabilité, duplication, couverture de tests, lignes de code et complexité cyclomatique).}
      \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{PROJETS ACADÉMIQUES}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\scriptsize Python, PyTorch, YOLO, ZED, apprentissage supervisé, détection/segmentation}\\
      \indentbox{\scriptsize Pipeline de détection/segmentation; fine-tuning, data augmentation et comparaison de modèles, avec métriques mAP, F1, précision/rappel d'environ 80 \% à 90 \%.}\\
    \end{minipage}
    &
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\scriptsize Python, Django REST, PostgreSQL, Next.js/React, Docker, Google Cloud APIs, SCRUM}\\
      \indentbox{\scriptsize API REST avec authentification JWT, modules CRUD, rapports et statistiques pour l'aide à la décision; back-end conteneurisé. \href{https://github.com/JavierTarazona06/ORIUN_back}{\textcolor{blue}{\underline{Plus d'informations}}}.}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\scriptsize Python, OpenCV, NumPy, scikit-learn, K-Means, Gaussian Naive Bayes, QDA, RGB/HSV/YCrCb}\\
      \indentbox{\scriptsize Extraction RGB/HSV/YCrCb puis comparaison de méthodes supervisées (Gaussian NB, QDA) et non supervisées (K-Means). \href{https://github.com/JavierTarazona06/Vision_LocalFeatures_BayesianClassification_KMeans/blob/main/docs/rappport/rap.pdf}{\textcolor{blue}{\underline{Plus d'informations}}}.}
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
