% !TeX root = 7Javier_TARAZONA_CV_CreditAgricoleDS.tex
...
}{}{0em}{}[\color{mydarkgreen}\titlerule \vspace{-4pt}]
...
\begin{minipage}[c]{\dimexpr\textwidth-\headerPhotoSpace\relax}
  \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
            ...
            \footnotesize Étudiant ingénieur IA / Data Science - profil international FR/EN/ES & \href{mailto:javier-andres.tarazona@ensta-paris.fr}{javier-andres.tarazona@ensta-paris.fr}\\
...
\textbf{Alternance Data Scientist - Data Analytics, Machine Learning et IA générative, à partir du septembre.} 
...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.24\textwidth}}
  ...
  \textit{\footnotesize Cours : ML, estimation statistique, bases de données, reconnaissance d'images, modèles de vision}
  \end{minipage}
  &
  ...
  \textit{\footnotesize Cours : stochastique/simulation, optimisation, probabilités-statistiques, BD, génie logiciel}
  \end{minipage}
  &
  \begin{minipage}[t]{\linewidth}\raggedleft
...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\small Stagiaire de recherche en IA, Vision 3D et génération de données}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft
      \textbf{Palaiseau, France}\\
      {\small\textit{Mai 2026 -- Présent}}
    \end{minipage}\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\small \textbf{- Deep Learning et Transformers : } Pré-entraînement auto-supervisé avec \textbf{PyTorch} et \textbf{Vision Transformers}; curriculum learning pour structurer les entraînements et l'évaluation.}
      \end{minipage}
    }\\[4pt]

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\small \textbf{- Pipelines de données : } Génération \textbf{Python/Blender} de rendus multi-vues, caméras, métadonnées et jeux de données contrôlés pour l'entraînement.}
      \end{minipage}
    }\\
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\small Machine Learning / NLP Engineer}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft 
      \textbf{Paris, France}\\
      {\small\textit{Octobre 2025 - Février 2026}}
    \end{minipage}\\

    \multicolumn{2}{l}{
    \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\small \textbf{- NLP et IA générative : } Application locale de correction de texte en français par \textbf{pipeline règles \& LLMs} (LanguageTool, Mistral/Gemma), avec NER spaCy, contrôles entités/nombres et sélection dynamique selon RAM/VRAM.}
    \end{minipage}
    }\\
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\small Ingénieur Logiciel et Vision par Ordinateur}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft 
      \textbf{Colombie - États-Unis}\\
      {\small\textit{12 mois : Jan. - Juil. 2024 et Fév. - Juin 2025}}
    \end{minipage}\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\small \textbf{- Refactorisation Python : } Refactorisation de deux bibliothèques en architecture objet/modulaire; amélioration de \textbf{70 \% du score de refactorisation} (indice de maintenabilité, duplication, couverture de tests, lignes de code et complexité cyclomatique).}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\small \textbf{- Computer Vision et analyse de données : } Optimisation OpenCV/NumPy pour voies/marquages routiers (\textbf{+50 \% vitesse, +60 \% précision}); clustering non supervisé et trajectoires WheelPath.}
      \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{PROJETS}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\small Python, PyTorch, YOLO, ZED, apprentissage supervisé, détection/segmentation}\\
      \indentbox{\small Pipeline de détection/segmentation; fine-tuning, data augmentation et comparaison de modèles, avec métriques mAP, F1, précision/rappel d'environ 80 \% à 90 \%.}\\
    \end{minipage}
    &
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\small Python, Django REST, PostgreSQL, Next.js/React, Docker, Google Cloud APIs, SCRUM}\\
      \indentbox{\small API REST avec authentification JWT, modules CRUD, rapports et statistiques pour l'aide à la décision; back-end conteneurisé. \href{https://github.com/JavierTarazona06/ORIUN_back}{\textcolor{blue}{\underline{Plus d'informations}}}.}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\small Python, OpenCV, NumPy, scikit-learn, K-Means, Gaussian Naive Bayes, QDA, RGB/HSV/YCrCb}\\
      \indentbox{\small Extraction RGB/HSV/YCrCb puis comparaison de méthodes supervisées (Gaussian NB, QDA) et non supervisées (K-Means). \href{https://github.com/JavierTarazona06/Vision_LocalFeatures_BayesianClassification_KMeans/blob/main/docs/rappport/rap.pdf}{\textcolor{blue}{\underline{Plus d'informations}}}.}
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
...
\begin{minipage}[t]{0.64\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      \item \textbf{Data Science / IA :} Python, PyTorch, scikit-learn, Pandas, NumPy, apprentissage supervisé/non supervisé, segmentation, évaluation
      ...
      \item \textbf{Data / DevOps :} SQL/PostgreSQL, Docker, GCP, Django/FastAPI, Git/GitHub, CI/CD, Agile/SCRUM
    \end{itemize}
  }
\end{minipage}\hfill
\begin{minipage}[t]{0.33\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=0pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      ...
      \item Sens du résultat, initiative, autonomie
