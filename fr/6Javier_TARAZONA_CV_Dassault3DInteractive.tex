...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Développement Python : } Refactorisation de deux bibliothèques en architecture objet/modulaire pour automatiser analyse d'images et traitement de données \textbf{(+80 \%)}.}
      \end{minipage}
    }\\
