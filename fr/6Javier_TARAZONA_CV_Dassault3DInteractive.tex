...
\section{\textcolor{mydarkgreen}{\textbf{PROJETS ACADÉMIQUES}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      \textbullet\ \textbf{"ORIUN" - Plateforme web de gestion et réservation}\\
      \textit{\footnotesize Python, Django, React, SQL, Docker, Google Cloud Platform, SCRUM}\\
      \indentbox{\footnotesize Prototype web supervisé et validé par l'Unité de Gestion de l'Innovation de l'UNAL; conception orientée utilisateur, communication et itérations produit. \href{https://github.com/JavierTarazona06/ORIUN_back}{\textcolor{blue}{\underline{Plus d'informations}}}.}\\
    \end{minipage}
    &
...
\begin{minipage}[t]{0.39\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      ...
      \item \textbf{3D \& web :} Blender/API Python, rendus multi-vues, données 3D synthétiques, React, JavaScript, Django, FastAPI
