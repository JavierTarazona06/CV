% !TeX root = 6Javier_TARAZONA_CV_Dassault3DInteractive.tex
...
}{}{0em}{}[\color{mydarkgreen}\titlerule \vspace{-2pt}]
...
\begin{minipage}[c]{\dimexpr\textwidth-\headerPhotoSpace\relax}
  \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
            ...
            \footnotesize Étudiant ingénieur (préparation Bac+5) - IA, LLMs, prototypage et expériences 3D & \href{mailto:javier-andres.tarazona@ensta-paris.fr}{javier-andres.tarazona@ensta-paris.fr}\\
...
\textbf{Alternance IA - workflows conversationnels pour expériences 3D interactives, à partir de septembre 2026.} 
...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.24\textwidth}}
  ...
  \textit{\footnotesize Cours : Machine Learning, Génie logiciel/POO, Bases de données, Reconnaissance d'images, Gestion de projet}
  \end{minipage}
  &
  ...
  \textit{\footnotesize Cours : Programmation, Langages de programmation, Génie logiciel, Systèmes d'information, Algorithmes}
  \end{minipage}
  &
  \begin{minipage}[t]{\linewidth}\raggedleft
...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Prototypage IA 3D : } Synthèse de nouvelles vues sur données 3D synthétiques; expérimentation mesurée par \textbf{curriculum learning}.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Authoring 3D avec Blender : } Pipeline \textbf{Python/Blender} pour rendus multi-vues, caméras, métadonnées et préparation de datasets.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Évaluation Deep Learning : } Pré-entraînement avec \textbf{PyTorch} et \textbf{Vision Transformers}; comparaison de configurations expérimentales.}
      \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
    \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Workflow LLM local : } Application de correction en français par \textbf{pipeline règles \& LLMs}; garde-fous NER spaCy, contrôles entités/nombres et sélection de modèles selon RAM/VRAM.}
    \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Prototypage et mesure : } Optimisation OpenCV/NumPy pour voies et marquages routiers (\textbf{+50 \% vitesse, +60 \% précision}); trajectoires WheelPath.}
      \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{PROJETS}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      \textbullet\ \textbf{ORIUN - Plateforme web de gestion des candidatures internationales}\\
      ...
      \indentbox{\footnotesize Conception full-stack d'une plateforme centralisée pour consulter des appels, soumettre des dossiers, suivre l'état d'une candidature et notifier les utilisateurs; API REST Django/JWT avec modules CRUD, rapports et statistiques, front-end Next.js/React déployé sur Vercel et back-end Docker/GCP. \href{https://github.com/JavierTarazona06/ORIUN_back}{\textcolor{blue}{\underline{Plus d'informations}}}.}\\
    \end{minipage}
    &
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \indentbox{\footnotesize Pipeline de détection/segmentation; fine-tuning, data augmentation et comparaison de modèles, avec métriques d'environ 80 \% à 90 \%.}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
...
\begin{minipage}[t]{0.39\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      \item \textbf{IA \& LLMs :} Python, PyTorch, Llama, spaCy, LanguageTool, pipelines règles/LLMs, Vision Transformers, OpenCV
      \item \textbf{3D \& web :} Blender/API Python, rendus multi-vues, données 3D synthétiques, React/Next.js, JavaScript, Django REST, FastAPI, TailwindCSS
      \item \textbf{Prototypage :} Docker, GCP, SQL/NoSQL, Git/GitHub, CI/CD, tests, Agile/SCRUM, architecture logicielle
    \end{itemize}
  }
\end{minipage}\hfill
\begin{minipage}[t]{0.28\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      \item Leadership
      \item Curiosité et apprentissage rapide
...
\begin{minipage}[t]{0.28\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      ...
      \item IA générative, 3D \\interactive et UX
    \end{itemize}
  }
\end{minipage}
