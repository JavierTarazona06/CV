% !TeX root = 8Javier_TARAZONA_CV_SG_IAgenerative.tex
...
\begin{minipage}[c]{\dimexpr\textwidth-\headerPhotoSpace\relax}
  \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
            ...
            \footnotesize Étudiant ingénieur IA (Bac +5) / Data Science - NLP, LLMs et Computer Vision & \href{mailto:javier-andres.tarazona@ensta-paris.fr}{javier-andres.tarazona@ensta-paris.fr}\\
...
\textbf{Alternance Data Scientist IA générative / Computer Vision - Société Générale Assurances, à partir de septembre 2026.}
...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.24\textwidth}}
  ...
  \textit{\footnotesize Diplôme d'Ingénieur - Master of Science in Engineering - Axé IA}\\
  \textit{\footnotesize Cours : Machine Learning, estimation statistique, bases de données, reconnaissance d'images, modèles de vision}
  \end{minipage}
  &
  ...
  \textit{\footnotesize Cours : probabilités-statistiques, modèles stochastiques/simulation, optimisation, BD, génie logiciel}
  \end{minipage}
  &
  \begin{minipage}[t]{\linewidth}\raggedleft
  ...
  \textit{\footnotesize Échange académique : ingénierie logicielle avancée, algorithmes, systèmes d'exploitation, français des affaires}
  \end{minipage}
  &
  \begin{minipage}[t]{\linewidth}\raggedleft
...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\footnotesize Stagiaire de recherche en IA, Vision 3D et génération de données}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Deep Learning et Transformers : } Pré-entraînement auto-supervisé avec \textbf{PyTorch} et \textbf{Vision Transformers}; curriculum learning pour structurer entraînements, métriques et évaluation.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Pipelines data : } Génération \textbf{Python/Blender} de rendus multi-vues, caméras, métadonnées et jeux de données contrôlés pour l'entraînement.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Reproductibilité : } Expérimentations en Python orientées traçabilité des paramètres, comparaison de configurations et apprentissage de représentations 3D.}
      \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
    \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- NLP et IA générative responsable : } Application locale de correction de texte en français par \textbf{pipeline règles \& LLMs} (LanguageTool, Mistral/Gemma), avec NER spaCy, contrôles entités/nombres et sélection dynamique selon RAM/VRAM.}
    \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Qualité logicielle Python : } Refactorisation de deux bibliothèques en architecture objet/modulaire; amélioration de \textbf{70 \% du score de refactorisation} (maintenabilité, duplication, tests, complexité).}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Computer Vision et analyse de données : } Optimisation OpenCV/NumPy pour voies/marquages routiers (\textbf{+50 \% vitesse, +60 \% précision}); clustering non supervisé et trajectoires WheelPath.}
      \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{PROJETS}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      \textbullet\ \textbf{"Tameo" - Vision embarquée pour système autonome (projet en cours)}\\
      \textit{\footnotesize Python, PyTorch, YOLO, ZED, DWA, apprentissage supervisé, détection/segmentation}\\
      \indentbox{\footnotesize Pipeline de détection/segmentation; fine-tuning, data augmentation et comparaison de modèles, avec suivi de métriques mAP, F1, précision/rappel d'environ 80 \% à 90 \%.}\\
    \end{minipage}
    &
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      \textbullet\ \textbf{ORIUN - Plateforme de gestion et reporting de candidatures internationales}\\
      \textit{\footnotesize Python, Django REST, PostgreSQL, Next.js/React, Docker, Google Cloud APIs, SCRUM}\\
      \indentbox{\footnotesize API REST avec authentification JWT, modules CRUD, rapports et statistiques pour l'aide à la décision; back-end conteneurisé et intégration de services Google Cloud. \href{https://github.com/JavierTarazona06/ORIUN_back}{\textcolor{blue}{\underline{Plus d'informations}}}.}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      \textbullet\ \textbf{Sharp Sight - API et pipeline de collecte/structuration d'offres}\\
      \textit{\footnotesize Python, FastAPI, Selenium, pandas, API REST, web scraping, Vercel}\\
      \indentbox{\footnotesize Collecte automatisée, nettoyage et structuration de données e-commerce; endpoints REST FastAPI, filtrage déterministe par chaînes et déploiement web. \href{https://github.com/JavierTarazona06/SharpSight}{\textcolor{blue}{\underline{Plus d'informations}}}.}
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
...
\begin{minipage}[t]{0.64\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      \item \textbf{Data Science / IA :} Python, PyTorch, scikit-learn, Pandas, NumPy, apprentissage supervisé/non supervisé, évaluation, segmentation
      \item \textbf{NLP / Computer Vision :} spaCy/NER, LanguageTool, Llama, Mistral/Gemma, Vision Transformers, OpenCV, YOLO, Blender/API Python
      \item \textbf{APIs / MLOps :} FastAPI, Django REST, SQL/PostgreSQL, Docker, GCP, Git/GitHub, CI/CD, tests, Agile/SCRUM
    \end{itemize}
  }
\end{minipage}\hfill
\begin{minipage}[t]{0.33\textwidth}
  \raggedright
  \textbf{\underline{Langues et savoir-être}}\\[-2pt]
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=0pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      ...
      \item Autonomie, initiative, sens du résultat
