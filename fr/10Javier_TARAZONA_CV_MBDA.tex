% !TeX root = 10Javier_TARAZONA_CV_MBDA.tex
...
\begin{minipage}[c]{\dimexpr\textwidth-\headerPhotoSpace\relax}
  \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
            ...
            \footnotesize Étudiant ingénieur -- Deep Learning, simulation numérique \& détection d'anomalies & \href{mailto:javier-andres.tarazona@ensta-paris.fr}{javier-andres.tarazona@ensta-paris.fr}\\
            \footnotesize ENSTA Paris / Institut Polytechnique de Paris -- Bac+5 en formation & \textbf{\textcolor{mydarkgreen}{Mobile:}} +33 07 46 36 97 75 \\
            
            \href{https://www.linkedin.com/in/javier-andres-tarazona-jimenez-84b489222/}{\textcolor{blue}{\underline{LinkedIn}}} & Massy, Île de France, France (91300)\\
...
\textbf{Disponible pour une alternance d'un an à partir de septembre 2026}
...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.24\textwidth}}
  ...
  \textit{\footnotesize Cours : Machine Learning, Estimation Statistique, Génie Logiciel OO, Bases de données, Systèmes Distribués, Reconnaissance d'Images}
  \end{minipage}
  &
  ...
  \textit{\footnotesize Cours : Modèles stochastiques et simulation, Modélisation/Simulation, Optimisation, Méthodes numériques, Génie Logiciel I/II}
  \end{minipage}
  &
  \begin{minipage}[t]{\linewidth}\raggedleft
  ...
  \textit{\footnotesize Échange académique -- Génie logiciel, Algorithmes, Systèmes d'exploitation}
  \end{minipage}
  &
  \begin{minipage}[t]{\linewidth}\raggedleft
...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\footnotesize Stagiaire de recherche -- IA \& Deep Learning sur données synthétiques}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Génération de données simulées : } Pipeline \textbf{Python/Blender} pour générer des jeux de données d'entraînement à partir d'objets 3D synthétiques (rendu multi-vues, caméras calibrées, métadonnées structurées).}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Deep Learning sur données simulées : } Entraînement avec \textbf{PyTorch} et \textbf{Vision Transformers}; apprentissage auto-supervisé de la structure 3D par prédiction de vues multiples.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Expérimentation et validation : } Curriculum learning sur formes géométriques progressives; conception du protocole d'expérimentation et validation des performances du modèle.}
      \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Industrialisation logicielle : } Refactorisation de deux bibliothèques Python en architecture modulaire; amélioration de \textbf{70 \% du score qualité} (maintenabilité, complexité cyclomatique, couverture de tests).}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Pipeline vision (OpenCV, NumPy) : } Optimisation du post-traitement pour voies/marquages routiers (\textbf{+50 \% vitesse, +60 \% précision}); génération de trajectoires WheelPath pour corrélation de données.}
      \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
    \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Pipeline NLP local : } Application de correction de texte en français par \textbf{LLMs locaux} et règles (LanguageTool, spaCy NER); guardrails, contrôle qualité et sélection adaptative selon contraintes RAM/VRAM.}
    \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{PROJETS}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\footnotesize Python, PyTorch, YOLO, ZED, apprentissage supervisé, détection/segmentation, métriques mAP/F1}\\
      \indentbox{\footnotesize Pipeline de vision pour la détection et la décision de mouvement d'un bateau autonome (Monaco Energy Boat Challenge 2026); fine-tuning sur datasets spécialisés, data augmentation et comparaison de modèles, avec amélioration des métriques mAP, F1, précision/rappel d'environ 80 \% à 90 \%.}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft
    \end{minipage}\\
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\footnotesize Python, Tkinter, OpenCV, MySQL, PyMySQL, Matplotlib, PIL/Pillow, POO}\\
      \indentbox{\footnotesize Application desktop pour analyser des vidéos de circulation, suivre des véhicules et estimer leur vitesse avec OpenCV; interface Tkinter avec authentification, gestion des données MySQL et visualisation Matplotlib. \href{https://github.com/JavierTarazona06/slow}{\textcolor{blue}{\underline{Plus d'informations}}}.}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft
    \end{minipage}\\
...
\begin{minipage}[t]{0.42\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      \item \textbf{IA / Data Science :} Python, PyTorch, Machine Learning, Deep Learning, Vision Transformers, scikit-learn, pandas, NumPy
      \item \textbf{Données \& simulation :} génération de datasets, Blender/API Python, OpenCV, pipelines de données, métriques d'évaluation
      \item \textbf{Logiciel :} C++/C, Java, SQL/NoSQL, Docker, Git/GitHub, CI/CD, Django, FastAPI, architecture logicielle
    \end{itemize}
  }
\end{minipage}\hfill
