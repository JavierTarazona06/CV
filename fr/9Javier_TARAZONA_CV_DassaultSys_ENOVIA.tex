% !TeX root = 9Javier_TARAZONA_CV_DassaultSys_ENOVIA.tex
...
}{}{0em}{}[\color{mydarkgreen}\titlerule \vspace{-7pt}]
...
\begin{minipage}[c]{\dimexpr\textwidth-\headerPhotoSpace\relax}
  \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
            ...
            \footnotesize Étudiant (préparation Bac+5) - Ingénieur en Systèmes et Informatique - Intelligence Artificielle & \href{mailto:javier-andres.tarazona@ensta-paris.fr}{javier-andres.tarazona@ensta-paris.fr}\\
            \footnotesize Machine Learning, Vision 2D et 3D, LLMs et prototypage & \textbf{\textcolor{mydarkgreen}{Mobile:}} +33 07 46 36 97 75 \\
...
\textbf{Recherche une alternance de dernière année -- Ingénieur IA : Agents LLM, Modèles génératifs \& Vision 3D, à partir de septembre 2026}
...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.24\textwidth}}
  ...
  \textit{\footnotesize Cours Pertinents : Machine Learning, Reconnaissance d'images, Systèmes Parallèles et Distribués}
  \end{minipage}
  &
  ...
  \textit{\footnotesize Cours Pertinents : Algorithmes et Structures de données, Systèmes multi-agents, Réseaux informatiques}
  \end{minipage}
  &
  \begin{minipage}[t]{\linewidth}\raggedleft
...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \multicolumn{2}{l}{
    \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Orchestration LLM \& NLP : } Pipeline hybride de correction de texte combinant règles \textbf{(LanguageTool)} et LLMs génératifs \textbf{(Mistral, Gemma)} ; guardrails NER spaCy, contrôle des entités/tokens, sélection dynamique du modèle selon RAM/VRAM pour garantir fiabilité et conformité.}
    \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Vision par Ordinateur (OpenCV, NumPy, Mathématiques) : }Optimisation du post-traitement pour voies/marquages routiers (\textbf{+50 \% vitesse, +60 \% précision}) et génération de trajectoires WheelPath pour corréler les détériorations.}
      \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{PROJETS}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      \textbullet\ \textbf{"Sharp Sight" -- Comparateur de prix via API REST}\\
      \textit{\footnotesize Python, FastAPI, Selenium, pandas, REST API, web scraping, Vercel}\\
      \indentbox{\footnotesize Backend de comparaison de prix pour dispositifs technologiques : pipeline automatisé de collecte, filtrage et catégorisation des offres e-commerce, \textbf{endpoints REST} avec FastAPI et déploiement cloud. \href{https://github.com/JavierTarazona06/SharpSight}{\textcolor{blue}{\underline{Plus d'informations}}}.}
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
...
\begin{minipage}[t]{0.39\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      \item \textbf{Outils d'IA :} Python, PyTorch, OpenCV, NumPy, spaCy, LanguageTool, LLMs (Llama, Mistral, Gemma), Vision Transformers, API REST (FastAPI)
