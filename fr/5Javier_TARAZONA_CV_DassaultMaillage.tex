% !TeX root = 5Javier_TARAZONA_CV_DassaultMaillage.tex
...
\begin{minipage}[c]{\dimexpr\textwidth-\headerPhotoSpace\relax}
  \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
            ...
            \footnotesize Étudiant ingénieur (préparation Bac+5) - IA, Machine Learning et Vision 3D & \href{mailto:javier-andres.tarazona@ensta-paris.fr}{javier-andres.tarazona@ensta-paris.fr}\\
...
\textbf{Alternance IA - reconnaissance de formes pour maillage surfacique, à partir de septembre 2026.} 
...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.24\textwidth}}
  ...
  \textit{\footnotesize Cours : Machine Learning, Reconnaissance d'images, Graphes/RO, Estimation statistique}
  \end{minipage}
  &
  ...
  \textit{\footnotesize Cours : Algorithmes, Structures de données, Optimisation, Méthodes numériques, Modélisation/simulation}
  \end{minipage}
  &
  \begin{minipage}[t]{\linewidth}\raggedleft
...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\footnotesize Stagiaire de recherche en IA, Vision 3D et données géométriques}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Données géométriques 3D : } Base synthétique de formes 3D progressives; \textbf{curriculum learning} pour représentations robustes.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Préparation de données IA : } Pipeline \textbf{Python/Blender} pour rendus multi-vues, caméras, métadonnées et datasets.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Prototypage Deep Learning : } Pré-entraînement auto-supervisé avec \textbf{PyTorch} et \textbf{Vision Transformers} pour structure 3D.}
      \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
    \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- IA fiable et prototypage : } Application locale \textbf{règles \& LLMs}; garde-fous NER spaCy, contrôles entités/nombres et adaptation RAM/VRAM.}
    \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Vision par ordinateur : } Optimisation OpenCV/NumPy pour voies et marquages routiers (\textbf{+50 \% vitesse, +60 \% précision}); trajectoires WheelPath.}
      \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{PROJETS}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \indentbox{\footnotesize Détection/segmentation pour bateau autonome; fine-tuning sur datasets spécialisés, data augmentation et comparaison de modèles, métriques d'environ 80 \% à 90 \%.}\\
    \end{minipage}
    &
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      \textbullet\ \textbf{Segmentation 2D et localisation de visage - Vision par ordinateur}\\
      \textit{\footnotesize Python, OpenCV, NumPy, scikit-learn, K-Means, Naive Bayes gaussien, RGB/HSV/YCrCb.}\\
      \indentbox{\footnotesize Comparaison de méthodes supervisées et non supervisées pour classifier/segmenter des pixels, avec protocole d'évaluation. \href{https://github.com/JavierTarazona06/Vision_LocalFeatures_BayesianClassification_KMeans/blob/main/docs/rappport/rap.pdf}{\textcolor{blue}{\underline{Plus d'informations}}}.}
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
...
\begin{minipage}[t]{0.39\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      \item \textbf{IA \& vision :} Python, PyTorch, OpenCV, NumPy, Pandas, scikit-learn, Vision Transformers, apprentissage supervisé/auto-supervisé
      \item \textbf{3D \& géométrie :} Blender/API Python, rendu multi-vues, caméras, données 3D synthétiques, notions de maillages et géométrie computationnelle
      \item \textbf{Développement :} C++/C, JavaScript, Git/GitHub, tests, CI/CD, Docker, FastAPI, SQL/NoSQL, architecture logicielle
    \end{itemize}
  }
\end{minipage}\hfill
...
\begin{minipage}[t]{0.28\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      ...
      \item IA pour géométrie 3D, CAO \\et jumeaux virtuels
    \end{itemize}
  }
\end{minipage}
