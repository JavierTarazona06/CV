...
\textbf{Recherche d'une alternance - Ingénieur IA, recomposition de segmentation 3D, à partir de septembre 2026.} 
...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.24\textwidth}}
  ...
  \textit{\footnotesize Cours : Machine Learning, Reconnaissance d'images, Estimation statistique, Graphes/RO}
  \end{minipage}
  &
  ...
  \textit{\footnotesize Cours : Algorithmes, Structures de données, Optimisation, Méthodes numériques}
  \end{minipage}
  &
  \begin{minipage}[t]{\linewidth}\raggedleft
...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\footnotesize Stagiaire de recherche en Intelligence Artificielle, Vision 3D et rendu multi-vues}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Vision 3D auto-supervisée : } Synthèse de nouvelles vues à partir de données 3D synthétiques et de formes géométriques progressives (\textbf{curriculum learning}).}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Données 3D et vues 2D : } Pipeline \textbf{Python/Blender} pour générer rendus multi-vues, caméras, métadonnées et jeux de données d'entraînement/validation.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Deep Learning et évaluation : } Pré-entraînement par prédiction de vues avec \textbf{PyTorch} et \textbf{Vision Transformers} pour apprendre la structure 3D.}
      \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
    \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- IA fiable et prototypage : } Application locale de correction de texte en français par \textbf{pipeline règles \& LLMs}, avec garde-fous NER spaCy, contrôles entités/nombres et adaptation RAM/VRAM.}
    \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Vision par ordinateur (OpenCV, NumPy, mathématiques) : } Optimisation du post-traitement pour voies/marquages routiers (\textbf{+50 \% vitesse, +60 \% précision}) et génération de trajectoires WheelPath.}
      \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{PROJETS ACADÉMIQUES}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \indentbox{\footnotesize Pipeline de vision pour la détection et la décision de mouvement d'un bateau autonome; fine-tuning sur datasets spécialisés, data augmentation et comparaison de modèles, avec amélioration des métriques mAP, F1, précision/rappel d'environ 75 \% à 90 \%.}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
...
\begin{minipage}[t]{0.39\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      \item \textbf{IA \& vision :} Python, PyTorch, OpenCV, NumPy, Pandas, scikit-learn, Vision Transformers, segmentation 2D, apprentissage auto-supervisé
      \item \textbf{3D \& géométrie :} Blender/API Python, rendu multi-vues, caméras, données 3D synthétiques, notions de maillages et géométrie algorithmique
      \item \textbf{Développement :} C++/C, Git/GitHub, tests automatiques, documentation, CI/CD, Docker, FastAPI, SQL/NoSQL, architecture logicielle
    \end{itemize}
  }
\end{minipage}\hfill
...
\begin{minipage}[t]{0.28\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      ...
      \item IA générative, CAO et \\jumeaux virtuels
    \end{itemize}
  }
\end{minipage}
