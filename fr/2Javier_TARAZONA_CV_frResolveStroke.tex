...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Traitement d'images en Python : } Refactorisation de deux bibliothèques en architecture orientée objet et modulaire, automatisant l'analyse d'images et le traitement de données \textbf{(+80 \% d'efficacité)}.}
      \end{minipage}
    }\\
