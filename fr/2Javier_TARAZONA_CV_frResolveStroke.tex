...
\begin{minipage}[c]{\dimexpr\textwidth-\headerPhotoSpace\relax}
  \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
            ...
            \footnotesize Étudiant ingénieur IA - Imagerie 3D et apprentissage auto-supervisé & \href{mailto:javier-andres.tarazona@ensta-paris.fr}{javier-andres.tarazona@ensta-paris.fr}\\
...
\textbf{Candidature ciblée aux stages Resolve Stroke postes 2 et 3 : traitement d'images 3D et apprentissage auto-supervisé, à partir de septembre 2026.} 
...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.24\textwidth}}
  ...
  \textit{\footnotesize Cours pertinents : Machine Learning, Deep Learning, Statistiques, Reconnaissance d'images, Optimisation}
  \end{minipage}
  &
...
\section{\textcolor{mydarkgreen}{\textbf{EXPÉRIENCE PROFESSIONNELLE}}}
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.4\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \textit{\footnotesize Stagiaire de recherche en apprentissage auto-supervisé et vision 3D}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Représentations auto-supervisées : } Pré-entraînement par prédiction de vues avec \textbf{PyTorch} et \textbf{Vision Transformers} pour apprendre des représentations de structure 3D.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Imagerie 3D et données : } Pipeline \textbf{Python/Blender} pour rendus multi-vues, caméras, métadonnées et jeux de données d'entraînement contrôlés.}
      \end{minipage}
    }\\

    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Protocoles expérimentaux : } Curriculum learning sur formes géométriques progressives pour structurer les entraînements, benchmarks et évaluations.}
      \end{minipage}
    }\\
    ...
    \multicolumn{2}{l}{
      \begin{minipage}[t]{\linewidth}\raggedright
        \indentbox{\footnotesize \textbf{- Filtrage et post-traitement : } Optimisation du post-traitement \textbf{OpenCV/NumPy} pour voies et marquages routiers (\textbf{+50 \% vitesse, +60 \% précision}) et génération de trajectoires WheelPath.}
      \end{minipage}
    }\\
...
\section{\textcolor{mydarkgreen}{\textbf{PROJETS}}}
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X >{\raggedleft\arraybackslash}p{0.01\textwidth}}
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      \textbullet\ \textbf{Segmentation de peau et localisation de visage - Vision par ordinateur}\\
    ...
    \begin{minipage}[t]{\linewidth}\raggedright
      ...
      \indentbox{\footnotesize Analyse vidéo pour reconnaissance de véhicules, suivi du trafic et mesure de vitesse. Projet orienté traitement d'images, détection d'objets et automatisation. \href{https://github.com/JavierTarazona06/slow}{\textcolor{blue}{\underline{Plus d'informations}}}.}\\
    \end{minipage}
    &
    \begin{minipage}[t]{\linewidth}\raggedleft %Texte here
    \end{minipage}\\
...
\begin{minipage}[t]{0.39\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      \item \textbf{IA \& imagerie :} Python, PyTorch, OpenCV, NumPy, Pandas, scikit-learn, Vision Transformers, apprentissage auto-supervisé, vision/reconstruction 3D
      \item \textbf{Analyse et prototypage :} traitement d'images, post-traitement, statistiques, optimisation, benchmarks, Blender/API Python
      \item \textbf{Méthodologies :} Git/GitHub, CI/CD, Agile (SCRUM), protocoles expérimentaux, évaluation de modèles
    \end{itemize}
  }
\end{minipage}\hfill
...
\begin{minipage}[t]{0.28\textwidth}
  ...
  {\scriptsize
    \begin{itemize}[leftmargin=*,itemsep=1pt,parsep=0pt,topsep=0pt,partopsep=0pt]
      ...
      \item MedTech et impact de l'IA \\sur la santé
    \end{itemize}
  }
\end{minipage}
